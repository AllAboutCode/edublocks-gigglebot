Blockly.Python['import_gigglebot'] = function(block) {
    var code = 'from gigglebot import *\n';
    return code;
};

Blockly.Python['gigglebot_init'] = function(block) {
    var code = 'init()\n';
    return code;
};
...
Blockly.Python['drive_x_milliseconds'] = function(block) {
    var dropdown_dir = block.getFieldValue('dir');
...
Blockly.Python['turn_x_milliseconds'] = function(block) {
    var dropdown_dir = block.getFieldValue('dir');
...
Blockly.Python['servo_off'] = function(block) {
    var dropdown_which = block.getFieldValue('which');
    var code = 'servo_off('+dropdown_which+')\n';
    return code;
};

Blockly.Python['set_smile'] = function(block) {
...
Blockly.Python['set_eyes'] = function(block) {
    var dropdown_which = block.getFieldValue('which');
    var number_R = Blockly.Python.valueToCode(block, 'R', Blockly.Python.ORDER_ATOMIC)
                        || '0';
    var number_G = Blockly.Python.valueToCode(block, 'G', Blockly.Python.ORDER_ATOMIC)
...
Blockly.Python['volt'] = function(block) {
    var code = 'volt()';
    return [code, Blockly.Python.ORDER_ATOMIC];
};
