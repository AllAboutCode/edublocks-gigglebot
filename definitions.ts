Blockly.Blocks['import_gigglebot'] = {
  init: function() {
...
Blockly.Blocks['drive_x_milliseconds'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("drive (")
        .appendField(new Blockly.FieldDropdown([["FORWARD","FORWARD"], ["BACKWARD","BACKWARD"]]), "dir")
...
Blockly.Blocks['turn_x_milliseconds'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("turn (")
        .appendField(new Blockly.FieldDropdown([["LEFT","LEFT"], ["RIGHT","RIGHT"]]), "dir")
